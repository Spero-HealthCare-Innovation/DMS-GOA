...
class Vehical_base_location(models.Model):
    ...
    bs_long = models.DecimalField(max_digits=9, decimal_place=6, null=True)
...
class Vehical(models.Model):
    ...
    veh_base_location = models.ForeignKey("veh_base_location")
    ...
    veh_city = models.ForeignKey(DMS_City, on_delete=models.CASCADE)
    veh_app_lat = models.DecimalField(max_digits=9, decimal_place=6, null=True)
    veh_app_log = models.DecimalField(max_digits=9, decimal_place=6, null=True)
    veh_gps_lat = models.DecimalField(max_length=9, decimal_place=6, null=True)
    veh_gps_log = models.DecimalField(maxLength=9, decimal_place=6, null=True)
    veh_address = models.TextField(null=True)
    veh_ward_id = models.ForeignKey(DMS_Ward, on_delete=models.CASCADE)
    status = enum.EnumField(status_enum, null=True)
