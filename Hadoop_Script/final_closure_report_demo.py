...
# ---------------------- Constants ----------------------
TABLE_NAME = "reports_demo.final_closure_report"
STAGING_TABLE_NAME = "reports_demo.closure_report_stage"
CHECKPOINT_DIR = "/tmp/spark_streaming_closure_report_demo"

# Incident Checkpoints
INC_CHECKPOINT_FILE = "/tmp/last_incident_modified_demo.txt"
INC_CHECKPOINT_ID_FILE = "/tmp/last_incident_id_demo.txt"

# Closure Checkpoints
CLOSURE_CHECKPOINT_FILE = "/tmp/last_closure_modified_demo.txt"
CLOSURE_CHECKPOINT_ID_FILE = "/tmp/last_closure_id_demo.txt"
...
def process_batch(df, epoch_id):
    try:
        ...
        combined_df.write \
            .mode("overwrite") \
            .format("parquet") \
            .option("path", "hdfs://10.108.1.41:9000/user/hive/warehouse/reports_demo.db/closure_report_stage") \
            .saveAsTable("reports_demo.closure_report_stage")
